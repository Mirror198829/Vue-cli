...
#login-main{width: 1200px;margin:0 auto;background:url('../assets/home/loginmain.png');background-position:-100px 20px;height:535px;background-repeat: no-repeat;background-size: 70%}
#login-main-left{}
