    ...
    <div class="content-top">
      <el-row>
        <el-col :span="12"><div class="grid-content bg-purple">
          ...
          <div style="margin-left: 80px" class="content-top-text" >
        ...
        <el-col :span="12"><div class="grid-content bg-purple-light">
          <img style="width: 600px;height: 300px" src="../../../assets/images/middleware/loadBance3.png"/>
        </div></el-col>
      </el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      onCreate(event){
        console.log(event);
        this.$router.push({ name: 'CreateLoadBalance'});
      },
      monitorSet(event){
